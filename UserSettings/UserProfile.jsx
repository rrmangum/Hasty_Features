...
export default function UserProfile(props) {
  ...
  _logger(props.currentUser.roles[0]);
  ...
  return (
    <Container>
      ...
      <Row>
        <Col className="col-3">
          <ProfileCard currentUser={props.currentUser} profileData={profileData} path="/dashboard/military" />
        </Col>
        <Col className="col-9">
              ...
              <Card.Body className="card-body">
                <Nav className="nav nav-pills bg-nav-pills nav-justified mb-3 flex" role="tablist">
                  <Nav.Item className="nav-item">
                    <Nav.Link to="#" role="tab" eventKey="profile" className="nav-link rounded-0">
                      {props.currentUser.roles.includes('Civilian') ? 'Civilian Profile' : null}
                      {props.currentUser.roles.includes('Active Duty') ? 'Military Profile' : null}
                      {props.currentUser.roles.includes('Veteran') ? 'Military Profile' : null}
                      {props.currentUser.roles.includes('Admin') ? 'Admin Profile' : null}
                      {props.currentUser.roles.includes('Proprietor') ? 'Proprietor Profile' : null}
                    </Nav.Link>
                  </Nav.Item>
                  <Nav.Item className="nav-item">
                ...
                <Tab.Content>
                  <Tab.Pane eventKey="profile">
                    {props.currentUser.roles.includes('Civilian') ? (<CivilianForm profileData={profileData} handleFormSubmit={handleFormSubmit}/>) : (<MilitaryForm />)}
                  </Tab.Pane>
                              ...
                              <div>
                                ...
                                <div className="row flex">
                                  <span className="text-muted">
                                    <a role="button" onClick={handleForgotPassword}>
