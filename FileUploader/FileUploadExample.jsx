    ...
    <React.Fragment>
      <div>
        <div className="container">
          <h3 className="div mt-5">
            Component renders for single file upload:
          </h3>
          ...
          <div className="row">
            <div className="col-4">
              <Formik
                ...
                initialValues={singleFileUpload.initialValues}
              >
                {({ setFieldValue }) => {
                  return (
                    <Form>
                      ...
                      <FileUploader
                        ...
                        handleUploadSuccess={(response) =>
                          parentHandleSingleUploadSuccess(
                            response,
                            setFieldValue
                          )
                        }
        ...
        <div className="container">
          <h3 className="div mt-5">
            Component renders for multiple file uploads:
          </h3>
          ...
          <div className="row">
            <div className="col-4">
              <Formik
                enableReinitialize={true}
                initialValues={MultipleFileUpload.initialValues}
              >
                {({ setFieldValue }) => {
                  return (
                    <Form>
                      ...
                      <FileUploader
                        isMultiple={true}
                        handleUploadSuccess={(response) =>
                          parentHandleMultipleUploadSuccess(
                            response,
                            setFieldValue
                          )
                        }
        ...
        <div className="container mt-5">
          <h3 className="div mt-5">
            Component Implementation without Formik wrapper:
          </h3>
          <FileUploader
            isMultiple={true}
            handleUploadSuccess={handleUploadSuccessNoFormik}
          />
        </div>
      </div>
    </React.Fragment>
